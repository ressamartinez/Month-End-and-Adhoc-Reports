...
where CAST(CONVERT(VARCHAR(10),opd.[Visit Start],101) as SMALLDATETIME) >= CAST(CONVERT(VARCHAR(10),'05/01/2020',101) as SMALLDATETIME)
	  and CAST(CONVERT(VARCHAR(10),opd.[Visit Start],101) as SMALLDATETIME) <= CAST(CONVERT(VARCHAR(10),'05/31/2020',101) as SMALLDATETIME)
	  --and opd.HN = '00420892'
