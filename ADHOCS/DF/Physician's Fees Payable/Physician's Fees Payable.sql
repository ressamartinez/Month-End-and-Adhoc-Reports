...
where CAST(CONVERT(VARCHAR(10),pp.period_date,101) as SMALLDATETIME) >= CAST(CONVERT(VARCHAR(10),'06/01/2019',101) as SMALLDATETIME)
	  and CAST(CONVERT(VARCHAR(10),pp.period_date,101) as SMALLDATETIME) <= CAST(CONVERT(VARCHAR(10),'06/30/2019',101) as SMALLDATETIME)
