...
where _gac.gl_acct_code_code in  ('4264000')	--Reader's Fee Revenue
...
where MONTH(ar.transaction_date_time) = 12
	 and YEAR(ar.transaction_date_time) = 2018
	 and ar.transaction_status_rcd not in ('unk','voi')
	AND gac.gl_acct_code_code IN ('4264000')	--Reader's Fee Revenue
