...
where 
			...
			and CAST(CONVERT(VARCHAR(10),sat.vendor_invoice_date_time,101) as SMALLDATETIME) >= CAST(CONVERT(VARCHAR(10),'06/15/2018',101) as SMALLDATETIME)
			and CAST(CONVERT(VARCHAR(10),sat.vendor_invoice_date_time,101) as SMALLDATETIME) <= CAST(CONVERT(VARCHAR(10),'07/31/2018',101) as SMALLDATETIME)
