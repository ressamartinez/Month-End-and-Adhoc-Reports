...
select DISTINCT
       tempb.charge_type_rcd
	   ,tempb.org_type
	   ,sum(tempb.gross_amount) as 'Total'
...
from (
	...
	from (
		...
		where ccs.year_id = 2019
			  and ccs.month_id between 1 and 6
			  and ccs.rpt_type = 'C'
...
group by tempb.org_type
         ,tempb.charge_type_rcd

order by tempb.charge_type_rcd
         ,tempb.org_type
