...
SET @dFrom = /*@From*/ '08/01/2018 00:00:00.000'		--Jan 2018 = 22667
SET @dTo = /*@To*/ '08/31/2018 23:59:59.998'
set @AsOFDate2 = /*@AsOf*/ '08/31/2018  23:59:59.998'	--30186
...
SELECT distinct tempb.[Invoice No.],
	   ...
	   tempb.[Payor],
		  ...
		  tempb.[Discount ER PF],
		   ...
		   tempb.[Owing Amount],
		   [Overdue in Days] = DATEDIFF(day,'08/31/2018', tempb.[Transaction Date and Time])
from
(
