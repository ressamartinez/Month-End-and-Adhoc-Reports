...
where _gac.gl_acct_code_code in  ('2152100')	--Physician's Fees Payable
...
where MONTH(ar.transaction_date_time) = 6
	 and YEAR(ar.transaction_date_time) = 2019
	 and ar.transaction_status_rcd not in ('unk','voi')
	AND gac.gl_acct_code_code IN ('2152100')	--Physician's Fees Payable
