...
SELECT 
			...
			,purchase_order_request.uom_rcd as [UOM]
			...
			,purchase_order_request.received_no as [Received No.]
	...
	WHERE ((MONTH(created_on_date) BETWEEN 1 AND 12) AND YEAR(created_on_date) = 2018)		
	--AND SPO.swe_purchase_site_id = '2198E881-0E1D-11DA-A79E-001143B8816C' )AS purchase_order_request --For Pharmacy Purchasing
	AND SPO.swe_purchase_site_id = '31488C46-FDB0-11D9-A79B-001143B8816C' )AS purchase_order_request  --For Central Purchasing
