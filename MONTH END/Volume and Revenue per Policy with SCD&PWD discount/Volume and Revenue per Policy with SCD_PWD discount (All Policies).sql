--Volume and Revenue per Policy per Specialty with SCD/PWD discount (All Policies)
...
(
				...
				SELECT DISTINCT ar.policy_id as [Policy ID]
							...
							,pv.actual_visit_date_time as [Admission Date and Time]
				...
				where ar.transaction_date_time  BETWEEN '01/01/2018 00:00:00:000' AND '03/31/2018 23:59:59:998'		--192219
