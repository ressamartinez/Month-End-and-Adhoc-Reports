--Volume and Revenue per Policy with IPD/OPD discount and SCD/PWD discount
...
(
				...
				where ar.policy_id IN  ('6AED3E14-6EDC-11E3-9A25-78E3B58FE3DB')  --2014 CIGNA INTERNATIONAL
										--('0D2C251E-6ED7-11E3-84F9-78E3B58FDD66', 'F359BE0B-63BA-11DA-BB34-000E0C7F3ED2' --2014 MAXICARE, MAXICARE
										--,'1B009CEE-6EDA-11E3-84F9-78E3B58FDD66', 'EDAA569D-7A90-11DA-BB34-000E0C7F3ED2' --2014 ASIAN LIFE, ASIAN LIFE
										--,'0562129E-6ED2-11E3-84F9-78E3B58FDD66', 'BDBF932F-4451-11DA-BB34-000E0C7F3ED2' --2014 COCOLIFE, COCOLIFE
										--,'7D59250E-6ED6-11E3-84F9-78E3B58FDD66') --2014 INTELLICARE
										

							AND MONTH(ar.transaction_date_time)  BETWEEN 7 AND 9
							and YEAR(ar.transaction_date_time) = 2019
							--AND MONTH(ar.transaction_date_time) = @Month

							AND ard.discount_posting_rule_id IN --(@discount_posting_rule_id)
																--('05F8582D-6E0D-11E3-A6A2-78E3B597EAF4'  --Inpatient Discount
																--,'3D06C575-6E0D-11E3-A6A2-78E3B597EAF4') --Outpatient Discount
																('60AF2DE3-04C9-11DF-AA84-0021912231AF'  --Discount for People with Disabilities
							...
							AND dpr.gl_acct_code_id IN ('D06BE6F5-6E0C-11E3-8117-0022195FB682' --Outpatient Discount
														...
														,'3D6A15CE-04C9-11DF-BC76-0022195FC77A' --Discount for people with disabilities
