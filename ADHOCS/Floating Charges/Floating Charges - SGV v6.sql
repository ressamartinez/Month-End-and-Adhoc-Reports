...
from charge_detail cd  inner JOIN item i on cd.item_id = i.item_id
						...
						left outer join lab_work_order lwo on cd.charge_session_id = lwo.charge_session_id
					    left outer JOIN cpoe_placer_order_status_ref cpos on lwo.cpoe_placer_order_status_rcd = cpos.cpoe_placer_order_status_rcd
