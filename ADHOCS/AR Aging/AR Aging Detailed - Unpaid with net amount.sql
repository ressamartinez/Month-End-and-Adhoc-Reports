...
SELECT tempb.*,
	  case when tempb.paid_amount > 0 THEN tempb.ar_net_amount - tempb.paid_amount else tempb.ar_net_amount end as balance,
	  case when (tempb.paid_amount + tempb.paid_2) > 0 then tempb.ar_net_amount - (tempb.paid_amount + tempb.paid_2) else tempb.ar_net_amount end  as bal_2,
	  case when (tempb.paid_amount + tempb.paid_2 + tempb.paid_3) > 0 then tempb.ar_net_amount - (tempb.paid_amount + tempb.paid_2 + tempb.paid_3) else tempb.ar_net_amount end  as bal_3,
	  case when (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4) > 0 then tempb.ar_net_amount - (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4) 
			    else tempb.ar_net_amount end  as bal_4,
	  case when (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4 + tempb.paid_5) > 0 then tempb.ar_net_amount - (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4 + tempb.paid_5) 
	            else tempb.ar_net_amount end  as bal_5,
	  case when (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4 + tempb.paid_5 + tempb.paid_6) > 0 
	            then tempb.ar_net_amount - (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4 + tempb.paid_5 + tempb.paid_6) else tempb.ar_net_amount end  as bal_6,
	 case when (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4 + tempb.paid_5 + tempb.paid_6 + tempb.paid_7) > 0 
	            then tempb.ar_net_amount - (tempb.paid_amount + tempb.paid_2 + tempb.paid_3 + tempb.paid_4 + tempb.paid_5 + tempb.paid_6 + tempb.paid_7) else tempb.ar_net_amount end  as bal_7
...
(
	...
	--where temp.invoice_no = 'CINV-2015-000005'
) as tempb
