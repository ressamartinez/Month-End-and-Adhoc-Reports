...
--where CAST(CONVERT(VARCHAR(10),arh.transaction_date_time,101) as SMALLDATETIME) >= CAST(CONVERT(VARCHAR(10),'02/01/2019',101) as SMALLDATETIME)
--	  and CAST(CONVERT(VARCHAR(10),arh.transaction_date_time,101) as SMALLDATETIME) <= CAST(CONVERT(VARCHAR(10),'05/17/2019',101) as SMALLDATETIME)
--	  and gac.gl_acct_code_code = '2152250'

where pp.period_id = (Select top 1 period_id from payment_period
