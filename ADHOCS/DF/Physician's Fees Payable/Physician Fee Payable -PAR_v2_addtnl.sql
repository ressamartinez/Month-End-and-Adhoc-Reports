...
from (	
	...
	where ar.transaction_status_rcd not in ('voi','unk')
		  and CAST(CONVERT(varchar(10),r.effective_date,101) as SMALLDATETIME) >= CAST(CONVERT(varchar(10),'02/01/2020',101) as SMALLDATETIME)
		  and CAST(CONVERT(varchar(10),r.effective_date,101) as SMALLDATETIME) <= CAST(CONVERT(varchar(10),'02/29/2020',101) as SMALLDATETIME)
