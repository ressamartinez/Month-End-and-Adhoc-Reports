...
where CAST(CONVERT(VARCHAR(10),pp.period_date,101) as SMALLDATETIME) >= CAST(CONVERT(VARCHAR(10),'07/26/2019',101) as SMALLDATETIME)
	  and CAST(CONVERT(VARCHAR(10),pp.period_date,101) as SMALLDATETIME) <= CAST(CONVERT(VARCHAR(10),'07/26/2019',101) as SMALLDATETIME)
